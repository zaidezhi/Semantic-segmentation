...
if __name__ == "__main__":
    ...
    #                 "tvmonitor"]
    name_classes = ["background","landslide","water","load","sky","vegetation"]
    # ----------------------------------------------------------------------------------------------------------#
    ...
    # ----------------------------------------------------------------------------------------------------------#
    test_interval = 500
    fps_image_path = "VOCdevkit/JPEGImages/test/"
    # -------------------------------------------------------------------------#
    ...
    # -------------------------------------------------------------------------#
    dir_origin_path = "VOCdevkit/JPEGImages/test/"
    dir_save_path = "VOCdevkit/result"
    # -------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        img_names = os.listdir(fps_image_path)
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(
                    ('.bmp', '.dib', '.png', '.jpg', '.jpeg', '.pbm', '.pgm', '.ppm', '.tif', '.tiff')):
                image_path = os.path.join(fps_image_path, img_name)
                image = Image.open(image_path)
                tact_time = deeplab.get_FPS(image, test_interval)
