...
if __name__ == '__main__':
    jpgs_path = "datasets/before/road"
    pngs_path = "datasets/SegmentationClass/road"
    # classes = ["_background_", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow",
    #            "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train",
    #            "tvmonitor"]
    classes     = ["_background_","landslide","water","load","sky","vegetation"]

    count = os.listdir("./datasets/JPEGImages/road")
    for i in range(0, len(count)):
        path = os.path.join("./datasets/JPEGImages/road", count[i])
