...
class DeeplabV3(object):
    _defaults = {
        ...
        # -------------------------------------------------------------------#
        # "model_path": 'logs/mobilenetv3/1ceng_feature/best_epoch_weights.pth',
        "model_path": 'logs/mobilenetv2/2ceng/best_epoch_weights.pth',
        # ----------------------------------------#
        #   所需要区分的类的个数+1
        # ----------------------------------------#
        "num_classes": 6,
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            ...
            #                (128, 64, 12)]
            # 论文颜色修改
            self.colors = [(0, 0, 0), (128, 0, 0), (135, 206, 250), (128, 128, 0), (0, 0, 255), (0, 128, 0), (0, 128, 128),
                           (128, 128, 128), (64, 0, 0), (192, 0, 0), (64, 128, 0), (192, 128, 0), (64, 0, 128), (192, 0, 128),
                           (64, 128, 128), (192, 128, 128), (0, 64, 0), (128, 64, 0), (0, 192, 0), (128, 192, 0), (0, 64, 128),
                           (128, 64, 12)]
        else:
